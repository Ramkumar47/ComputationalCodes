...
module boundary_conditions
    ...
    ! east
    character(len=30), parameter :: u_east_type = "linear"
    ...
    real(kind=ikd), parameter :: p_south_value = 0.0
    ! east
    character(len=30), parameter :: p_east_type = "linear"
    real(kind=ikd), parameter :: p_east_value = 0.0
    ! west
    character(len=30), parameter :: p_west_type = "fixedValue"
    real(kind=ikd), parameter :: p_west_value = P_inf
    ...
    real(kind=ikd), parameter :: T_south_value = 300.0
    ! east
