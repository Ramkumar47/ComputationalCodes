...
program main
    ...
    mainloop: do epoch = 1,N_epochs
        ...
        evaluation: do ival = 1,batch_size
            ...
            lossVal = 1.0/batch_size*((y_pred(current_index) - y(current_index))**2)

            ! performing back propagation for the last layer
            dLdsigma = 2.0/batch_size*(y_pred(current_index) - y(current_index))
