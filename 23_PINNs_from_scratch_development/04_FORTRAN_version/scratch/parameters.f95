...
module parameters
    ...
    ! integer(kind=ikd), dimension(*), parameter :: layers = (/20,20,20,20,20,20,1/)
    integer(kind=ikd), dimension(*), parameter :: layers = (/10,10,10,10,1/)
    integer(kind=ikd), parameter :: N_layer = size(layers)

    ! number of epochs
    integer(kind=ikd), parameter :: N_epochs = 2000
