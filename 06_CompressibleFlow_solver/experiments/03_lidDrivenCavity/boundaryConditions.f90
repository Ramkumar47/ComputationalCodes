...
module boundary_conditions
    ...
    ! east
    character(len=30), parameter :: u_east_type = "fixedValue"
    real(kind=ikd), parameter :: u_east_value = 0.0
    ! west
    character(len=30), parameter :: u_west_type = "fixedValue"
    real(kind=ikd), parameter :: u_west_value = 0.0
    ...
    ! east
    character(len=30), parameter :: v_east_type = "fixedValue"
    ...
    ! variable-----------------------------------------------------------------
    ! north
    character(len=30), parameter :: p_north_type = "linear"
    ...
    ! east
    character(len=30), parameter :: p_east_type = "linear"
    ...
    real(kind=ikd), parameter :: T_north_value = T_inf*1.2
    ! south
    character(len=30), parameter :: T_south_type = "fixedValue"
    real(kind=ikd), parameter :: T_south_value = T_inf
    ! east
    character(len=30), parameter :: T_east_type = "fixedValue"
    real(kind=ikd), parameter :: T_east_value = T_inf
    ! west
