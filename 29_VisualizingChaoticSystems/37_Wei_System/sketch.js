...
// let hueCoeff = 11.32; // hue slope coeff. for lyapunov coloring
// let hueOff = -26; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = -yVal;
    yDot = xVal+zVal;
    zDot = 0.6*xVal*zVal+yVal**2-1;
