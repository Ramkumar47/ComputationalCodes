...
let xRange = [-2,2]; // range of coordinates
let yRange = [-2,2];
let zRange = [-2,2];
...
let hueCoeff = 98; // hue slope coeff. for lyapunov coloring
let hueOff = -133; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = -yVal*zVal;
    yDot = 2*xVal*zVal+yVal*zVal+zVal**3;
    zDot = xVal-xVal**3;
...
function setup() {
    ...
    describe('Time-Reversible Reflection-Invariant System',LABEL);
    frDiv = createDiv('');
