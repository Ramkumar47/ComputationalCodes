...
let hueOff = 1.7; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = zVal;
    yDot = -yVal+zVal;
    zDot = -xVal+0.48*yVal+yVal**2;
...
function setup() {
    ...
    describe('Sprott J System',LABEL);
    frDiv = createDiv('');
