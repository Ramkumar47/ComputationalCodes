...
// let hueCoeff = 20; // hue slope coeff. for lyapunov coloring
// let hueOff = -4.5; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = -0.32*xVal-yVal-zVal-yVal**2;
    yDot = -0.32*yVal-zVal-xVal-zVal**2;
    zDot = -0.32*zVal-xVal-yVal-xVal**2;
...
function setup() {
    ...
    describe('Halvorsen System',LABEL);
    frDiv = createDiv('');
