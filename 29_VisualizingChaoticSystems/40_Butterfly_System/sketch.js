...
// let hueCoeff = 11.28; // hue slope coeff. for lyapunov coloring
// let hueOff = -7.78; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal+yVal*zVal;
    yDot = -xVal*zVal+yVal*zVal;
    zDot = -0.5*zVal-xVal*yVal+1;
...
function setup() {
    ...
    describe('Butterfly System',LABEL);
    frDiv = createDiv('');
