...
let Tstop = 500.0; // simulation end time
...
let xRange = [-3,3]; // range of coordinates
let yRange = [-3,3];
let zRange = [-3,3];
...
// let hueCoeff = 6; // hue slope coeff. for lyapunov coloring
// let hueOff = 1.5; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal-xVal;
    yDot = -0.3*xVal-xVal*zVal+0.7*yVal;
    zDot = xVal*yVal-0.1*zVal;
