...
let xRange = [-12,12]; // range of coordinates
let yRange = [-12,12];
let zRange = [-12,12];
...
function setup() {
    ...
    describe('Megastable System',LABEL);
    frDiv = createDiv('');
