...
let hueCoeff = 3.1; // hue slope coeff. for lyapunov coloring
let hueOff = -2.1; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal;
    yDot = -xVal+zVal;
    zDot = xVal+xVal*zVal+0.3*yVal;
...
function setup() {
    ...
    describe('Sprott O System',LABEL);
    frDiv = createDiv('');
