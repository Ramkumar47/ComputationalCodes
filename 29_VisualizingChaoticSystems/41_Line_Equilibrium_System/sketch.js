...
let xRange = [-8,8]; // range of coordinates
let yRange = [-8,8];
let zRange = [-8,8];
...
let hueCoeff = 10.75; // hue slope coeff. for lyapunov coloring
let hueOff = -15.38; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal;
    yDot = -xVal+yVal*zVal;
    zDot = 0.3*xVal-xVal*yVal+0.1*xVal*zVal;
...
function setup() {
    ...
    describe('Line Equilibrium System',LABEL);
    frDiv = createDiv('');
