...
let xRange = [-4,4]; // range of coordinates
let yRange = [-4,4];
let zRange = [-4,4];
...
let hueCoeff = 21.12; // hue slope coeff. for lyapunov coloring
let hueOff = 2.0; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal+xVal*yVal+xVal*zVal;
    yDot = 1-xVal**2+yVal*zVal;
    zDot = xVal-0.61*xVal**2-yVal**2;
...
function setup() {
    ...
    describe('Dissipative-Conservative System',LABEL);
    frDiv = createDiv('');
