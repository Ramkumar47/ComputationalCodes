...
// let hueCoeff = 5.31; // hue slope coeff. for lyapunov coloring
// let hueOff = 0.0; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = 1+yVal*zVal;
    yDot = -xVal*zVal;
    zDot = yVal**2+2*yVal*zVal;
...
function setup() {
    ...
    describe('Mostly Quadratic System',LABEL);
    frDiv = createDiv('');
