...
let xRange = [-60,60]; // range of coordinates
let yRange = [-60,60];
let zRange = [-60,60];
...
// let hueCoeff = 2.54; // hue slope coeff. for lyapunov coloring
// let hueOff = 29; // hue slope coeff. for lyapunov coloring
...
function setup() {
    ...
    describe('Wang-Chen System',LABEL);
    frDiv = createDiv('');
