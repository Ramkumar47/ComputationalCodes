...
let hueOff = 1.3; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal;
    yDot = -xVal+zVal**2;
    zDot = 1+0.24*yVal-zVal;
...
function setup() {
    ...
    describe('Sprott N System',LABEL);
    frDiv = createDiv('');
