...
let dt = 2.5e-2; // simulation timestep
...
// let hueCoeff = 0.12; // hue slope coeff. for lyapunov coloring
// let hueOff = 34.3; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal;
    yDot = -xVal-2*Math.sign(zVal)*yVal;
    zDot = yVal**2-1;
...
function setup() {
    ...
    describe('Signum Thermostat System',LABEL);
    frDiv = createDiv('');
