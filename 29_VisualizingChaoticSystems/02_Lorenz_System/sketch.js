...
// let hueCoeff = 84; // hue slope coeff. for lyapunov coloring
// let hueOff = -76; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = yVal-xVal;
    yDot = -xVal*zVal+xVal;
    zDot = xVal*yVal-0.08*zVal;
