...
// let hueCoeff = 138; // hue slope coeff. for lyapunov coloring
// let hueOff = 34; // hue slope coeff. for lyapunov coloring

// equation function definition
function f(xVal,yVal,zVal){
    xDot = 5*yVal;
    yDot = -xVal+0.1*yVal+sin(zVal);
    zDot = 1;
...
function setup() {
    ...
    describe('Forced Ueda System',LABEL);
    frDiv = createDiv('');
